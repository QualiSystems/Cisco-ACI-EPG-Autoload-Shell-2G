...
class CiscoACIAppProfile(AbstractResource):
    RESOURCE_MODEL = "Cisco ACI App Profile"
    RELATIVE_PATH_TEMPLATE = "AP"

    def __init__(self, shell_name, name, unique_id, shell_type="CS_CiscoACIAppProfile"):
        super(CiscoACIAppProfile, self).__init__(shell_name, name, unique_id)
